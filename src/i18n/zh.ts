...
const zh: LANG_MESSAGE = {
  ...
  updateNodeServerScript: '更新OpenClash节点脚本',
  updateNodeServerScriptSuccess: '节点脚本已更新，请重启 node server 进程后生效',
  chains: '代理链',
  outbound: '出站节点',
  sortBy: '排序方式',
  rule: '规则',
  ...
  proxiesSimpleView: '简洁代理列表',
  proxiesMoreNodes: '更多节点…',
  proxiesPickNodeTitle: '选择节点',
  proxiesFilterNodes: '筛选…',
  type: '类型',
  process: '进程',
  connectTime: '连接时间',
  sourcePort: '源端口',
