  ...
  <div class="flex flex-col text-sm">
    ...
    <template v-if="hasVisibleProxyStyleItems">
      ...
      <div class="settings-grid">
        ...
        <div
          v-if="isVisibleProxiesSimpleView"
          class="setting-item"
        >
          <div class="setting-item-label">
            {{ $t('proxiesSimpleView') }}
...
const isVisibleProxiesSimpleView = useIsSettingVisible(k.proxiesSimpleView)
...
const hasVisibleProxyStyleItems = computed(() => {
  return (
    ...
    isVisibleProxiesSimpleView.value ||
